document.addEventListener('DOMContentLoaded', () => {
    ...
    const happyBirthdaySound = document.getElementById('happyBirthdaySound'); // Lấy âm thanh Happy Birthday
    const birthdayMessage = document.getElementById('birthdayMessage'); // Chữ chạy qua màn hình

    // Ẩn chữ chúc mừng sinh nhật ban đầu
    birthdayMessage.style.animationPlayState = 'paused'; 
            ...
            .then(stream => {
                ...
                function detectBlow() {
                    ...
                    if (averageLevel > 100) {
                        ...
                        // Play Happy Birthday song after fireworks
                        happyBirthdaySound.play();

                        // Bắt đầu hiệu ứng chữ chạy qua màn hình sau khi thổi nến
                        birthdayMessage.style.animationPlayState = 'running'; 
